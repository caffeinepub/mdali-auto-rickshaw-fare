...
export class Backend implements backendInterface {
    ...
    async addTrip(arg0: number, arg1: bigint, arg2: number, arg3: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addTrip(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getLast10Trips(): Promise<Array<Trip>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLast10Trips();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
